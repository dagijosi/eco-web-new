...
const SearchBar = () => (
  <div className="flex md:flex-row flex-col justify-center items-center gap-2">
    <input
      ...
      className="p-2 border rounded-md md:rounded-l-md w-full md:w-auto h-10 focus:outline-none"
    />
    <input
      type="date"
      placeholder="Pick a date..."
      className="p-2 border-t border-b w-full md:w-auto h-10 focus:outline-none"
    />
